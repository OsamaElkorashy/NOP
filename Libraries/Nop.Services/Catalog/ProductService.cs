...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// /// <param name="discountId">Discount identifiers</param>
        /// <param name="storeId">Store identifier; 0 to load all records</param>
            ...
            bool? overridePublished = null)
        {
            return SearchProducts(out var _, false,
                pageIndex, pageSize, categoryIds, manufacturerId,discountId,
            ...
            bool? overridePublished = null)
        {
            ...
            var pDiscountId = SqlParameterHelper.GetInt32Parameter("DiscountId", discountId);
