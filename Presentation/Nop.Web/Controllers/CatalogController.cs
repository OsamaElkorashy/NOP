...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public virtual IActionResult DiscountProducts(int DiscountId, CatalogPagingFilteringModel command)
        
        {
            ...
            var model = _catalogModelFactory.PrepareDiscountProductsModel(DiscountId,command);
            return View(model);
        }
